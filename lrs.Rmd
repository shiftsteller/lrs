...
library("jsonlite")
  ...
  statusText <- paste0("The S and P 500 is ", signals$status, " the 195 day average. Price: ", signals$price, "195 day average: ", signals$SMA, ".")
  cat(statusText)
  cat("\n\n")
  cat("Details: \n")
  print(signals)
...
textChange <- paste0(statusText, " Check https://formrtestlrs.formr.org/.")
